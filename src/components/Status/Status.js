...
export default function Status(props) {
  ...
  return (
    <section className="Status">
      ...
      <div>
        <p>
          Cortando <span>{estoque.trabalhador * transacoes.cortar.madeira * processos.cortar}</span> madeiras/seg
        </p>
        <p>
          Lucrando <span>{estoque.comercio * transacoes.vender.ouro * processos.vender}</span> ouros/seg
        </p>
      </div>
      <div>
